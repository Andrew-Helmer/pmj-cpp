...
For a Rust version, see [Simon Brown's implementation](https://github.com/sjb3d/pmj). Simon also had a key insight on how to optimally pick subquadrants during sample generation, which improved the quality of the sequences generated by this code.
